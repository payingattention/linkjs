define(['./request'], function(Request) {
    ...
    var Response = function(opt_code, opt_reason, opt_headers, opt_body, opt_contenttype) {
        opt_code        && this.code(opt_code);
        opt_reason      && this.reason(opt_reason);
    ...
    Response.prototype.code = function(opt_code) {
        if (opt_code) { this.__code = opt_code; return this; }
        return this.__code;
    };
    // reason('phrase') -> this; reason() -> 'phrase';
    Response.prototype.reason = function(opt_reason) {
        if (opt_reason) { this.__reason = opt_reason; return this; }
        return this.__reason;
    };
    // header({ key1:'value1', key2:'value2' }) -> this;  header('key') -> value;
    Response.prototype.header = function(key_or_headerKVs) {
    ...
    Response.prototype.body = function(opt_body, opt_contentype) {
