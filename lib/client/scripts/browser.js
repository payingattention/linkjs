...
// Toplevel FSDEF
var define_fs = function() {
    // build virtual files
    fs.define('/proc'); fs.listen('/proc', fsh_proc)
    fs.define('/sys/exec'); fs.listen('/sys/exec', fsh_sys_exec)
    fs.define('/local'); fs.listen('/local', fsh_local)
}
